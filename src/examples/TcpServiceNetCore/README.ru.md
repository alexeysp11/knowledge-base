...
- [ ] Движок отображает все контролы сверху вниз и слева направо.
...
- [ ] Для коммуникации с серверным приложением используется библиотека `ClientAdapter`: отправляет TCP-запросы на сервис и возвращает двумерный массив символов заданного размера.
